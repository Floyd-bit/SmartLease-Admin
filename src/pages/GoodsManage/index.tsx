 ...
 * @LastEditors: 赵卓轩
 * @LastEditTime: 2021-07-19 10:46:38
 */
...
const GoodsManage: React.FC = () => {
  ...
  function onChange(value) {
    ...
    setStoreId(value.nativeEvent.data);
  }
    ...
    <PageContainer>
      ...
      <ProTable<TableListItem>
        ...
        toolBarRender={() => [
          // 选择店铺
          <>
          <Input placeholder="输入店铺Id" onChange={onChange}/>
          <Button
            type="primary"
            key="primary"
            onClick={() => {
        ...
        request={
          (params,sorter,filter) => queryRule({ ...params,sorter,filter,currentPage,storeId}).then(response => {
            const result = {
